...
class QuadGraph {
   ...
   * (width, height)
   */
  public boolean intersect(PVector line1, PVector line2, int width,
      int height) {
   ...
   * @param c1
   */
  public boolean isConvex(PVector c1, PVector c2, PVector c3,
      PVector c4) {
   ...
   */
  public boolean validArea(PVector c1, PVector c2, PVector c3,
   ...
   * rectangle)
   */
  public boolean nonFlatQuad(PVector c1, PVector c2, PVector c3,
      PVector c4) {
  ...
  public float minCos (PVector c1, PVector c2, PVector c3, PVector c4) {
